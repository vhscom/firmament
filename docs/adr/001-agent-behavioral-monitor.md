...
- **Agent-Sentry** learns behavioral bounds from execution traces and uses them for runtime behavioral sequence detection, tracking ordered invocation sequences and data provenance. It blocks 90-96% of attacks while preserving 95-98% utility. Academic only.
...
- Agent-Sentry — Learns behavioral bounds from execution traces for anomaly detection. (2026, arXiv 2603.22868)
